...
public class WitchRobe extends DressItem {

    public WitchRobe(ModX mod, Properties properties) {
    ...
    public static class RenderProperties implements DressRenderProperties {
        ...
        @Model("dress/witch_robe")
        public static BakedModel mainModel;
        
        @Model("dress/witch_robe_arm")
        public static BakedModel armModel;
